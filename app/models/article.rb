class Article < ApplicationRecord
  ...
  validates :price, presence: true,  #価格の情報が必須であること
                    numericality: { greater_than_or_equal_to: 300, less_than_or_equal_to: 9_999_999 },  #価格は、¥300~¥9,999,999の間のみ保存可能であること
                    format: { with: /\A[0-9]+\z/, message: "must be a half-width number" } #価格は半角数値のみ保存可能であること
